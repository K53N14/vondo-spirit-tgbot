...
При удалении пользователя (`Удалить везде`) бот дополнительно пытается автоматически удалить сервисное сообщение Telegram о выходе/удалении пользователя из группы.
