...
- `/apply_admins_here` — в текущем чате назначить admin-права всем пользователям из БД, кто присутствует в чате; модераторы получают full rights, rank берется из БД.
